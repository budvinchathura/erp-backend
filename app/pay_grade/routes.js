...
router.post('/add', [valid_jwt_needed,minimum_access_level_required(['L1','L2','L3'])],pay_grade_controller.add);
router.patch('/add', [valid_jwt_needed,minimum_access_level_required(['L1','L2','L3'])],pay_grade_controller.update);
