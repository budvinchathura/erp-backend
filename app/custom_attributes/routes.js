...
router.post('/add', [valid_jwt_needed,minimum_access_level_required(['L3'])],custom_attribute_controller.add);
router.patch('/add', [valid_jwt_needed,minimum_access_level_required(['L3'])],custom_attribute_controller.update);
