...
router.patch('/basic',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_basic_details]);
router.post('/contact',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),employee_controller.insert_contact_details]);
router.patch('/contact',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_contact_details]);
...
router.patch('/email',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_email]);
...
router.patch('/dependent',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_dependent]);
...
router.patch('/emergency',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_emergency_contact]);
...
router.patch('/custom',[valid_jwt_needed,minimum_access_level_required(['L1','L2','L3']),has_authority,employee_controller.update_custom_attribute]);
