...
-- Script date 12/29/2019 9:33:52 PM
...
ALTER TABLE erp.employee 
  ADD CONSTRAINT employee_ibfk_1 FOREIGN KEY (job_title)
    REFERENCES erp.job_title(job_title);
ALTER TABLE erp.employee 
  ADD CONSTRAINT employee_ibfk_2 FOREIGN KEY (employment_status)
    REFERENCES erp.employment_status(employment_status);
ALTER TABLE erp.employee 
  ADD CONSTRAINT employee_ibfk_4 FOREIGN KEY (pay_grade)
    REFERENCES erp.pay_grade(pay_grade);
ALTER TABLE erp.employee 
...
ALTER TABLE erp.employee 
  ADD CONSTRAINT employee_ibfk_6 FOREIGN KEY (dept_name)
    REFERENCES erp.department(dept_name);
...
ALTER TABLE erp.employee_custom_attributes 
  ADD CONSTRAINT employee_custom_attributes_ibfk_1 FOREIGN KEY (attribute)
    REFERENCES erp.custom_attribute(attribute);
ALTER TABLE erp.employee_custom_attributes 
...
ALTER TABLE erp.`leave` 
  ADD CONSTRAINT leave_ibfk_2 FOREIGN KEY (leave_type)
    REFERENCES erp.leave_type(leave_type);
